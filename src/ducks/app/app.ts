...
export default function reduceApp(state = {}, action: any) {
  // default state
  const appState: any = {
    shouldClose: false,
    menuOpen: false,
...
export function toggleGasLoadingAnimation(value: any) {
  return { type: actionConstants.TOGGLE_GAS_LOADING_ANIMATION, value };
}

export function setLedgerWebHidConnectedStatus(value: any) {
  return { type: actionConstants.SET_WEBHID_CONNECTED_STATUS, value };
}

export function setLedgerTransportStatus(value: any) {
  return { type: actionConstants.SET_LEDGER_TRANSPORT_STATUS, value };
}

// Selectors
export function getQrCodeData(state: any) {
  return state.appState.qrCodeData;
}

export function getGasLoadingAnimationIsShowing(state: any) {
  return state.appState.gasLoadingAnimationIsShowing;
}

export function getLedgerWebHidConnectedStatus(state: any) {
  return state.appState.ledgerWebHidConnectedStatus;
}

export function getLedgerTransportStatus(state: any) {
  return state.appState.ledgerTransportStatus;
}

export function getPortfolioTooltipWasShownInThisSession(state: any) {
...
export function setNewCustomNetworkAdded(value: any) {
  return { type: actionConstants.SET_NEW_CUSTOM_NETWORK_ADDED, value };
}

export function setOnBoardedInThisUISession(value: any) {
  return { type: actionConstants.ONBOARDED_IN_THIS_UI_SESSION, value };
}

export function setCustomTokenAmount(value: any) {
